...
namespace SistemaBiblioteca.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookID,Title,SerialNumber,AuthorID,PublisherID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookID,Title,SerialNumber,AuthorID,PublisherID")] Book book)
        {
            if (id != book.BookID)
            {
                return NotFound();
